 ...
 * <ul>
 *     <li><b>环境变量</b>：借助 Spring 宽松绑定，{@code alipay.gateway} 对应 {@code ALIPAY_GATEWAY}，
 ...
 * <ul>
 *     <li>{@code ALIPAY_GATEWAY} → {@code alipay.gateway}</li>
...
public class AlipaySdkConfig {
    ...
    /** 支付宝网关地址，对应 {@code alipay.gateway} / {@code ALIPAY_GATEWAY}，默认正式环境网关 */
    @Value("${alipay.gateway:https://openapi.alipay.com}")
